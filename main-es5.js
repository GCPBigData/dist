...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 18,
      vars: 0,
      consts: [["fullscreen", ""], ["sidenav", ""], ["mat-list-item", "", "href", "https://www.linkedin.com/in/jose-r-f-junior-b72b6b1a/", "target", "_blank"], ["mat-list-icon", ""], ["mat-line", "", "translate", ""], ["color", "primary"], ["mat-icon-button", "", 3, "click"], [1, "app-content"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _chat_chat_module__WEBPACK_IMPORTED_MODULE_5__["ChatModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_10__["MatMenuModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateModule"].forRoot({
        loader: {
  ...
  function srcAppChatChatComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_model_action__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./shared/model/action */
    "./src/app/chat/shared/model/action.ts");
    /* harmony import */


    var _shared_model_event__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./shared/model/event */
    "./src/app/chat/shared/model/event.ts");
    /* harmony import */


    var _shared_services_socket_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./shared/services/socket.service */
    "./src/app/chat/shared/services/socket.service.ts");
    /* harmony import */


    var _dialog_user_dialog_user_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./dialog-user/dialog-user.component */
    "./src/app/chat/dialog-user/dialog-user.component.ts");
    /* harmony import */


    var _dialog_user_dialog_user_type__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./dialog-user/dialog-user-type */
    ...
    function ChatComponent_mat_list_item_6_img_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 19);
      }

      if (rf & 2) {
        var message_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function ChatComponent_mat_list_item_6_h4_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ChatComponent_mat_list_item_6_p_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ChatComponent_mat_list_item_6_p_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ChatComponent_mat_list_item_6_p_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p", 21);
    ...
    function ChatComponent_mat_list_item_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function ChatComponent(socketService, dialog, translate) {
      ...
      _createClass(ChatComponent, [{
        ...
        value: function initModel() {
          ...
          this.user = {
            id: randomId,
            avatar: "".concat(AVATAR_URL, "/").concat(randomId, ".png")
          };
        }
      }, {
        ...
        value: function initIoConnection() {
          ...
          this.socketService.onEvent(_shared_model_event__WEBPACK_IMPORTED_MODULE_4__["Event"].CONNECT).subscribe(function () {
            console.log('connected');
          });
          this.socketService.onEvent(_shared_model_event__WEBPACK_IMPORTED_MODULE_4__["Event"].DISCONNECT).subscribe(function () {
        ...
        key: "onClickUserInfo",
        value: function onClickUserInfo() {
          this.openUserPopup({
            data: {
        ...
        key: "openUserPopup",
        value: function openUserPopup(params) {
          var _this4 = this;
          ...
          this.dialogRef.afterClosed().subscribe(function (paramsDialog) {
            ...
            _this4.user.name = paramsDialog.username;

            if (paramsDialog.dialogType === _dialog_user_dialog_user_type__WEBPACK_IMPORTED_MODULE_7__["DialogUserType"].NEW) {
              _this4.initIoConnection();

              _this4.sendNotification(paramsDialog, _shared_model_action__WEBPACK_IMPORTED_MODULE_3__["Action"].JOINED);
            } else if (paramsDialog.dialogType === _dialog_user_dialog_user_type__WEBPACK_IMPORTED_MODULE_7__["DialogUserType"].EDIT) {
              _this4.sendNotification(paramsDialog, _shared_model_action__WEBPACK_IMPORTED_MODULE_3__["Action"].RENAME);
            }
          });
        }
      }, {
    ...
    ChatComponent.ɵfac = function ChatComponent_Factory(t) {
      return new (t || ChatComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_shared_services_socket_service__WEBPACK_IMPORTED_MODULE_5__["SocketService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateService"]));
    };
    ...
    ChatComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 27,
      vars: 7,
      consts: [["mat-fab", "", 3, "click"], [1, "chat-container"], [1, "main-card"], [1, "chat-list"], [3, "ngClass", 4, "ngFor", "ngForOf"], [1, "chat-footer-container"], [1, "chat-input"], ["matInput", "", "maxlength", "140", 3, "placeholder", "ngModel", "ngModelChange", "keyup.enter"], ["inputMessage", ""], ["align", "end"], ["mat-icon-button", "", 1, "button-globe", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", "", 3, "click"], ["alt", "flag", "src", "../../../assets/flags/en.png"], ["alt", "flag", "src", "../../../assets/flags/pt.png"], [3, "ngClass"], ["mat-list-avatar", "", 3, "src", 4, "ngIf"], ["mat-line", "", 4, "ngIf"], ["mat-line", "", "class", "chat-notification", 4, "ngIf"], ["mat-list-avatar", "", 3, "src"], ["mat-line", ""], ["mat-line", "", 1, "chat-notification"], ["translate", ""]],
      template: function ChatComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ChatComponent_Template_button_click_0_listener($event) {
            return ctx.onClickUserInfo();
          });
          ...
          })("keyup.enter", function ChatComponent_Template_input_keyup_enter_11_listener($event) {
            return ctx.sendMessage(ctx.messageContent);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ChatComponent_Template_button_click_21_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ChatComponent_Template_button_click_24_listener($event) {
            return ctx.switchLanguage("pt");
          });

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](25, "img", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](26, " Portugu\xEAs");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ChatComponent, [{
        ...
        return [{
          type: _shared_services_socket_service__WEBPACK_IMPORTED_MODULE_5__["SocketService"]
        }, {
        ...
        matList: [{
          ...
          args: [_angular_material_list__WEBPACK_IMPORTED_MODULE_2__["MatList"], {
        ...
        matListItems: [{
          ...
          args: [_angular_material_list__WEBPACK_IMPORTED_MODULE_2__["MatListItem"], {
            read: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]
          }]
        }]
      });
  ...
  function srcAppChatChatModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_material_material_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    ChatModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _shared_material_material_module__WEBPACK_IMPORTED_MODULE_3__["MaterialModule"]]]
    });
  ...
  /***/
  function srcAppChatDialogUserDialogUserTypeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DialogUserType", function () {
      return DialogUserType;
    });
  ...
  /***/
  function srcAppChatDialogUserDialogUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DialogUserComponent", function () {
    ...
    function DialogUserComponent_mat_dialog_actions_23_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DialogUserComponent_mat_dialog_actions_23_Template_button_click_1_listener($event) {
    ...
    function DialogUserComponent_mat_dialog_actions_24_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DialogUserComponent_mat_dialog_actions_24_Template_button_click_3_listener($event) {
    ...
    var DialogUserComponent =
    /*#__PURE__*/
    function () {
      function DialogUserComponent(dialogRef, params, translate) {
        _classCallCheck(this, DialogUserComponent);
      ...
      _createClass(DialogUserComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "onSave",
    ...
    DialogUserComponent.ɵfac = function DialogUserComponent_Factory(t) {
      return new (t || DialogUserComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"]));
    };

    DialogUserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: DialogUserComponent,
      selectors: [["app-dialog-user"]],
      decls: 25,
      vars: 11,
      consts: [[1, "row"], ["mat-dialog-title", "", 1, "dialog-title"], ["mat-icon-button", "", "mat-dialog-title", "", "tabindex", "-1", 1, "button-globe", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", "", 3, "click"], ["alt", "flag", "src", "../../../assets/flags/en.png"], ["alt", "flag", "src", "../../../assets/flags/pt.png"], [1, "dialog-content"], ["matInput", "", "name", "username", "required", "", 3, "placeholder", "formControl", "keyup.enter"], ["translate", ""], [4, "ngIf"], ["mat-raised-button", "", "color", "primary", "mat-dialog-close", "", 3, "disabled", "click"], ["mat-button", "", "mat-dialog-close", "", "color", "secondary"], ["mat-raised-button", "", "color", "primary", "mat-dialog-close", "", 3, "click"]],
      template: function DialogUserComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DialogUserComponent_Template_button_click_9_listener($event) {
            return ctx.switchLanguage("en");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DialogUserComponent_Template_button_click_12_listener($event) {
            return ctx.switchLanguage("pt");
          });

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](13, "img", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](14, " Portugu\xEAs");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup.enter", function DialogUserComponent_Template_input_keyup_enter_17_listener($event) {
            return ctx.onSave();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DialogUserComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppChatSharedModelActionTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppChatSharedModelEventTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppChatSharedServicesSocketServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppSharedMaterialMaterialModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    MaterialModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_2__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCardModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialogModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_8__["MatListModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_9__["MatSidenavModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_10__["MatToolbarModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_11__["TranslateModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_12__["MatMenuModule"]], _angular_material_button__WEBPACK_IMPORTED_MODULE_2__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCardModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialogModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_8__["MatListModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_9__["MatSidenavModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_10__["MatToolbarModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_11__["TranslateModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_12__["MatMenuModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](MaterialModule, {
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_2__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCardModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialogModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_8__["MatListModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_9__["MatSidenavModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_10__["MatToolbarModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_11__["TranslateModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_12__["MatMenuModule"]],
        exports: [_angular_material_button__WEBPACK_IMPORTED_MODULE_2__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCardModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialogModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_8__["MatListModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_9__["MatSidenavModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_10__["MatToolbarModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_11__["TranslateModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_12__["MatMenuModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppSharedSharedModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SharedModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _material_material_module__WEBPACK_IMPORTED_MODULE_2__["MaterialModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateModule"]], _material_material_module__WEBPACK_IMPORTED_MODULE_2__["MaterialModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SharedModule, {
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _material_material_module__WEBPACK_IMPORTED_MODULE_2__["MaterialModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateModule"]],
        exports: [_material_material_module__WEBPACK_IMPORTED_MODULE_2__["MaterialModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\usuario\Documents\Dev\socket-io-typescript-chat\client\src\main.ts */
    "./src/main.ts");
    /***/
  },
